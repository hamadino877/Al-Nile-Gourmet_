...
if (isOpen) {
  ...
  return { open: false, label: "🔴 مغلق - يفتح ١١:٠٠ ص" };
}
}
...
"https://i.ibb.co/qLJFq3gc/mixboard-image-18.png",  // 16 (was duplicate of 15)
...
"https://i.ibb.co/LznHXLNB/mixboard-image-98.png",  // 26 (was duplicate of 25)
"https://i.ibb.co/JRYNLDn0/mixboard-image-99.png",  // 27 (was duplicate of 25)
"https://i.ibb.co/kVqQw7Vp/mixboard-image-100.png", // 28 (was duplicate of 25)
...
"https://i.ibb.co/4n3VqVpr/mixboard-image-86.png",  // 49 (was duplicate of 48)
...
"https://i.ibb.co/hR7pGkTj/mixboard-image-91.png",  // 55 (was duplicate of 54)
...
"https://i.ibb.co/TMc8w1b9/mixboard-image-117.png", // 81 (was duplicate of 76)
...
catering:   [I[40], I[41], I[42], I[43], I[44], I[45]],
};
...
{ ar: "انتركوت",              en: "Entrecôte",            price: "85 درهم"  },
{ ar: "مكعبات لحم",           en: "Beef Cubes",            price: "67 درهم"  },
{ ar: "لحم مفروم",            en: "Minced Meat",           price: "65 درهم"  },
{ ar: "روستو",                en: "Roast Beef",             price: "67 درهم"  },
{ ar: "بيكاتا",               en: "Piccata",                price: "67 درهم"  },
{ ar: "بوفتيك",               en: "Buftek",                 price: "67 درهم"  },
{ ar: "بيف استروجانوف",        en: "Beef Stroganoff",        price: "67 درهم"  },
{ ar: "شاورما اللحم",          en: "Meat Shawarma",          price: "67 درهم"  },
{ ar: "فيليه أستيك",           en: "Steak Fillet",           price: "120 درهم" },
{ ar: "كبدة بقري",             en: "Sliced Liver",           price: "58 درهم"  },
{ ar: "ريش بتلو",              en: "Beef Chops",             price: "80 درهم"  },
{ ar: "ريب آي",                en: "Ribeye",                 price: "85 درهم"  },
{ ar: "موزة بقري بدون عظم",    en: "Beef Shank boneless",    price: "67 درهم"  },
{ ar: "موزة بقري بالعظم",      en: "Beef Shank with bone",   price: "60 درهم"  },
{ ar: "كبدة إسكندراني",        en: "Alexandrian Liver",      price: "58 درهم"  },
{ ar: "رقبة بتلو",             en: "Neck Beef",              price: "60 درهم"  },
{ ar: "عكاوي",                 en: "Oxtail",                 price: "42 درهم"  },
{ ar: "كوارع",                 en: "Trotters",               price: "37 درهم"  },
]},
{ section: "naimi", title: "لحوم ضاني نعيمي", titleEn: "Naimi Lamb", pool: "naimi", items: [
{ ar: "موزة ضاني نعيمي",       en: "Naimi Lamb Shank",       price: "72 درهم"  },
{ ar: "كتف ضاني نعيمي",        en: "Naimi Lamb Shoulder",    price: "72 درهم"  },
{ ar: "ريش ضاني نعيمي",        en: "Naimi Lamb Chops",       price: "120 درهم" },
{ ar: "خروف نعيمي بدون عظم",   en: "Naimi Lamb boneless",    price: "85 درهم"  },
{ ar: "فخذة ضاني نعيمي",       en: "Naimi Lamb Leg",         price: "72 درهم"  },
{ ar: "رقبة ضاني نعيمي",       en: "Naimi Lamb Neck",        price: "72 درهم"  },
]},
{ section: "aus", title: "لحوم ضاني أسترالي", titleEn: "Australian Lamb", pool: "aus", items: [
{ ar: "رقبة ضاني أسترالي",     en: "Aus. Lamb Neck",         price: "68 درهم"  },
{ ar: "فخذة ضاني أسترالي",     en: "Aus. Lamb Leg",          price: "68 درهم"  },
{ ar: "كتف ضاني أسترالي",      en: "Aus. Lamb Shoulder",     price: "68 درهم"  },
{ ar: "لحم أسترالي بدون عظم",  en: "Aus. Lamb boneless",     price: "78 درهم"  },
{ ar: "ريش ضاني أسترالي",      en: "Aus. Lamb Chops",        price: "120 درهم" },
{ ar: "موزة ضاني أسترالي",     en: "Aus. Lamb Shank",        price: "70 درهم"  },
]},
{ section: "chicken", title: "دجاج وطيور", titleEn: "Poultry", pool: "chicken", items: [
{ ar: "أفخاذ بالعظم",          en: "Chicken Thighs",         price: "42 درهم" },
{ ar: "دجاج مكعبات",           en: "Chicken Cubes",          price: "50 درهم" },
{ ar: "صدور دجاج أستيك",        en: "Chicken Steak",          price: "50 درهم" },
{ ar: "صدور دجاج مخلية",        en: "Chicken Breast",         price: "50 درهم" },
{ ar: "دجاجة كاملة",            en: "Full Chicken",           price: "26 درهم" },
...
{ ar: "ستيك فيليه متبل",        en: "Marinated Steak Fillet",   price: "120 درهم" },
...
{ ar: "ريش متبلة",              en: "Marinated Lamb Chops",     price: "120 درهم" },
...
{ section: "catering", title: "الكاترنج", titleEn: "Catering", pool: "catering", catering: true, items: [
{ ar: "خدمة الكاترنج", en: "Catering Service", price: "0" },
]},
];
...
raw.forEach(sec => {
  ...
  cats.push({ id: cid, name: sec.title, nameEn: sec.titleEn, type, catering: !!sec.catering });
  if (!sec.catering) {
...
const IconBack   = () => <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>;
...
function CateringCard() {
  return (
    <div className="catering-card" style={{ gridColumn: "span 2" }}>
      <div className="catering-sparkles">
        <span>✨</span><span>🍽️</span><span>✨</span>
      </div>
      <h2 className="catering-title">خدمة الكاترنج</h2>
      <p className="catering-sub">Catering Service</p>
      <p className="catering-desc">
        نقدم خدمات الكاترنج الاحترافية للمناسبات والحفلات والمؤتمرات.<br/>
        أفضل الأطباق المصرية الأصيلة لضيوفك الكرام 🌿
      </p>
      <div className="catering-features">
        <div className="cf-item">🎂 <span>حفلات الأعراس</span></div>
        <div className="cf-item">🏢 <span>مناسبات الشركات</span></div>
        <div className="cf-item">🎉 <span>الحفلات الخاصة</span></div>
        <div className="cf-item">🍖 <span>تشكيلة لحوم فاخرة</span></div>
      </div>
      <a
        href={`https://wa.me/971554099255?text=${encodeURIComponent('مرحباً، أريد الاستفسار عن خدمة الكاترنج 🍽️')}`}
        target="_blank"
        rel="noreferrer"
...
function MenuScreen({ items, cats, shopType, switchShopType, activeCat, setActiveCat, search, setSearch, addToCart, openDetail }) {
  const isCatering = activeCat !== "all" && cats.find(c => c.id === activeCat)?.catering;
  const visibleItems = isCatering ? [] : items;
  return (
    <div>
      <div className="sth">
        ...
        <span style={{ fontSize: 12, color: "var(--g)", fontWeight: 800, background: "var(--sf1)", padding: "4px 10px", borderRadius: 20, border: "1px solid var(--bd)" }}>
          {isCatering ? "كاترنج" : `${items.length} عنصر`}
        </span>
      </div>
      ...
      <div className="cscr" style={{ paddingTop: 12 }}>
        ...
        {cats.map(c => (
          <button key={c.id} className={`cc ${activeCat===c.id?"on":""} ${c.catering?"cc-catering":""}`} onClick={() => setActiveCat(c.id)}>
            {c.catering ? "🍽️ " : ""}{c.name}
          </button>
        ))}
      </div>
      ...
      <div className="grid" style={{ paddingBottom: 24 }}>
        {isCatering && <CateringCard />}
        {!isCatering && visibleItems.map((item, i) =>
          item.variants
            ? <WideCard key={item.id} item={item} onAdd={(p, lbl) => addToCart(item, p, lbl)} onView={() => openDetail(item)} />
            : <FoodCard key={item.id} item={item} onAdd={() => addToCart(item)} onView={() => openDetail(item)} idx={i} />
        )}
        {!isCatering && visibleItems.length === 0 && (
...
<SafeImg src={item.img} alt={item.name} style={{ width: 52, height: 52, borderRadius: 10, objectFit: "cover", flexShrink: 0, opacity: isAvail ? 1 : 0.45 }} />
